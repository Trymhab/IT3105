...
__mnist_path__ = "/Users/ludvigpedersen/OneDrive - NTNU/4. klasse høst/IT3105/Projects/Project1/mnist-zip/"
def load_mnist(dataset="training", path = __mnist_path__, digits=numpy.arange(10)):
